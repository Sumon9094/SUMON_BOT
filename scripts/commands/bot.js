...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  const fallbackReplies = [
    "আমি এখন ইভান বস এর সাথে বিজি আছি",
    " বট ডাকছোস মানে ইভান তোর বাপ?",
    "I love you baby meye hole chipay aso",
    "Love you 3000-😍💋💝",
    "ji bolen ki korte pari ami apnar jonno?",
    "আমাকে না ডেকে আমার বস সুমনকে ডাকেন! link: https://www.facebook.com/100001435123762",
    "Hmm jan ummah😘😘",
    "বট ডাকলে ইভান তোর বাবা🫦🫶?",
    "ভালোবাসি তোমাকে 🤖",
    "Hi, 🤖 i can help you~~~~"
  ];
